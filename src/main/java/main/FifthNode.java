 ...
 * @author Admin
 */
public class FifthNode extends javax.swing.JFrame {

    private server sv;
    public FifthNode() {
        this.setTitle("FifthNode");
        initComponents();
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        if(this.tfPort.equals("")){
            ...
            this.sv = new server(this,3005,4,this.tpLog,this.tfSendToCoordinator,this.btnSendToCoordinator);
            this.sv.execute();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FifthNode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
