 ...
 * @author Admin
 */
public class ThirdNode extends javax.swing.JFrame {

    private server sv;
    public ThirdNode() {
        this.setTitle("ThirdNode");
        initComponents();
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        if(this.tfPort.equals("")){
            ...
            this.sv = new server(this,3003,2,this.tpLog,this.tfSendToCoordinator,this.btnSendToCoordinator);
            this.sv.execute();
            ...
            if(n == null){
                ...
                System.out.println("ban chinh la dieu phoi vien");
            }
//            else{
//                this.tfSendToCoordinator.setEditable(true);
//                this.btnSendToCoordinator.setEnabled(true);
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThirdNode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
